...
if __name__ == '__main__':
    ...
    net2 = {'id':2, 'mask':24, 'ip':'192.168.1.0'}
    ...
    host_min = (ip2dec(net['ip']) >> shift_mask << shift_mask)+1
    host_max = (ip2dec(net['ip']) >> shift_mask << shift_mask)+pow(2, shift_mask)-1
